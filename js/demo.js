...
let page=1;
const getMonsters=a=>{console.log('get monsters function'),fetch(URL_PREFIX+`monsters/?_limit=50&_page=${a}`)
.then(b=>b.json())
...
createMonsterForm=()=>{const a=document.createElement('form'),
